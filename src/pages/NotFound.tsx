/**
 * 404 Not Found page with competitor stack context
 */
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-4">
      <div className="text-center">
        ...
        <p className="text-gray-600 mb-8">
          {domainFromUrl
            ? `We couldn't find a competitor analysis for "${domainFromUrl}". This domain might not exist in our database yet.`
            : "The competitor analysis you're looking for doesn't exist."}
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Button
            onClick={() =>
              navigate("/", {
                state: { showForm: true, domainToGenerate: domainFromUrl },
              })
            }
            variant="outline"
